...
```js
insert into szemely2(nev, szulev, foglalkozas) values ('Kiss Bela',2000,'Lakatos');
insert into szemely2(nev, szulev, foglalkozas) values ('Nagy Ivo',1999,'diak');
insert into szemely2(nev, szulev, foglalkozas) values ('Toth otto',1980,'pincer');
```
...
update szemely
set vegzettseg = vegzettseg + ['x', 'y']
where nev = 'Kiss Bela' AND szulev = ... AND fogl ... //MINDENT MEG KELL ADNI NEM CSAK NEV
```
